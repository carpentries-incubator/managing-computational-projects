...
Data Science for Biomedical Research Project

>Idea for potential sketch???: A brick wall, in which lower bricks are data science with different types of data: imaging files, sequencing files, csv/excel files... /then data science/then FAIR concepts, Reproducibility, management... /then ML/AI ??? (like, to imply that without the proper basics you won't have a robust AI/ML project) 
...
In contrast to the definition above, we think research which is not data intensive would also gain in applying data science principles.
